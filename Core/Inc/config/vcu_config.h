...
// Inverter data
#define TORQUE_LIM_POS 2000
#define TORQUE_LIM_NEG -100
#define ID110 107.2f

// CAN transmit speeds
// Inverter must have messages sent at a minimum of 20Hz
#define INVERTER_TORQUE_COMMAND_CAN_TRANSMIT_RATE pdMS_TO_TICKS(10) // 100Hz
#define CAN_2_TRANSMIT_RATE pdMS_TO_TICKS(40) // 25Hz

// Time between inverter error reset attempts
#define INVERTER_ERROR_RESET_RATE pdMS_TO_TICKS(250) // 4Hz
#define MAX_ERROR_RESET_ATTEMPTS 50

// Software timer durations
#define RTD_BUTTON_PRESS_MILLISECONDS pdMS_TO_TICKS(300)
...
#define MAX_TORQUE_PERCENTAGE 50
